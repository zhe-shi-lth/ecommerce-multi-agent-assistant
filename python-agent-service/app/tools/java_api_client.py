...
class JavaApiClient:
    ...
    def persist_operation_plan(
        ...
        payload = {
            ...
            "orderId": order_id,
            "productPlanJson": result.product_plan.model_dump(),
            "imagePlanJson": result.image_plan.model_dump(),
            "inventoryPlanJson": result.inventory_plan.model_dump(),
            "fulfillmentPlanJson": result.fulfillment_plan.model_dump(),
